...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      validate_symptoms: { Args: { symptom_list: string[] }; Returns: boolean }
      validate_triggers: { Args: { trigger_list: string[] }; Returns: boolean }
    }
    Enums: {
      feedback_status:
        | "new"
        ...
        | "implemented"
        | "wont_fix"
      feedback_type: "feedback" | "feature_request"
    }
    CompositeTypes: {
      [_ in never]: never
    }
